...
physical_constants::physical_constants(double nu, double E, double rho0)
    : m_nu(nu), m_E(E), m_rho0(rho0) {}
...
double constants_monaghan::mghn_corr_exp() const { return m_mghn_corr_exp; }

double constants_monaghan::mghn_eps() const { return m_mghn_eps; }

constants_monaghan::constants_monaghan(double wdeltap, double corr_exp,
                                       double eps)
    : m_mghn_wdeltap(wdeltap), m_mghn_corr_exp(corr_exp), m_mghn_eps(eps) {}
...
constants_artificial_viscosity::constants_artificial_viscosity(double alpha,
                                                               double beta,
                                                               double eta)
...
correction_constants::correction_constants(
    constants_monaghan monaghan_constants,
    constants_artificial_viscosity constants_art_visc, double xsph_eps)
    : m_xsph_eps(xsph_eps),
...
bool correction_constants::do_smooth() const { return m_do_smooth; }

constants_monaghan correction_constants::get_monaghan_const() const {
  return m_constants_monaghan;
}

constants_artificial_viscosity correction_constants::get_art_visc_const()
    const {
...
simulation_data::simulation_data(physical_constants physical_constants,
                                 correction_constants correction_constants)
    : m_physical_constants(physical_constants),
      m_correction_constants(correction_constants){};
