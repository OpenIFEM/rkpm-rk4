...
class correction_constants {
 ...
 public:
  correction_constants(constants_monaghan monaghan_constants,
                       constants_artificial_viscosity constants_art_visc,
                       double xsph_eps);
  correction_constants(constants_monaghan monaghan_constants,
                       constants_artificial_viscosity constants_art_visc,
                       double xsph_eps, bool smooth);
...
class simulation_data {
 ...
 public:
  simulation_data();
  simulation_data(physical_constants physical_constants,
